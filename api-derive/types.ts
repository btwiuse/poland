...
import type { ApiInterfaceRx } from 'https://deno.land/x/polkadot@0.0.0-11/api-base/types/index.ts';
import type { u32 } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { Balance, BlockNumber, BountyIndex, Hash, Proposal, ProposalIndex, SetIndex, Votes } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletBountiesBounty, PalletTreasuryProposal } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
