...
import type { u32, Vec } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { AccountId32, Balance, BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
