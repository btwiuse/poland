...
import type { u32, Vec } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { AccountId32, Balance, BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
