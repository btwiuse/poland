...
import type { QueryableModuleStorage } from 'https://deno.land/x/polkadot@0.0.0-11/api-base/types/index.ts';
import type { Vec } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { AccountId, Balance } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletElectionsPhragmenVoter } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
