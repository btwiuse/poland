...
import type { Bytes, Option, u32, Vec } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { CollatorId, ParaId, ParaInfo, Retriable, UpwardMessage } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
