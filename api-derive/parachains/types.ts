...
import type { Bytes, Option, u32, Vec } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { CollatorId, ParaId, ParaInfo, Retriable, UpwardMessage } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
