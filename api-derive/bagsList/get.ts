...
import type { Option, u64 } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { PalletBagsListListBag } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
...
import { BN_ZERO, bnToBn } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
