...
import type { Option, u64 } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { PalletBagsListListBag } from 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts';
...
import { BN_ZERO, bnToBn } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
