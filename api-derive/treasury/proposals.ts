...
import type { ProposalIndex } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletTreasuryProposal } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
