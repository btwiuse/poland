...
import type { Option, u32, Vec } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { AccountId, BalanceOf } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletSocietyBid } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
