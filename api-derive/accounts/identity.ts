...
import type { PalletIdentityIdentityInfo, PalletIdentityRegistration } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
import type { Option } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
...
import { isHex, u8aToString } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
