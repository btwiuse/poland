...
import type { PalletIdentityIdentityInfo, PalletIdentityRegistration } from 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts';
...
import { isHex, u8aToString } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
