...
import type { AccountId, Address, Balance } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
import type{ PalletElectionsPhragmenSeatHolder } from 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.0.0-10/types/types/index.ts';
import type { Option } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { DeriveAccountFlags, DeriveApi } from '../types.ts';

import { map, of } from 'https://esm.sh/rxjs@7.5.5';

import { isFunction } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
