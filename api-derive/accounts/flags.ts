...
import type { AccountId, Address, Balance } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type{ PalletElectionsPhragmenSeatHolder } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.0.0-11/types/types/index.ts';
...
import { isFunction } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
