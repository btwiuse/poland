...
import type { H256 } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
