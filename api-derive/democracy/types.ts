...
import type { Vec } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { AccountId, Balance, BlockNumber, Hash, PropIndex, Proposal, ReferendumIndex, ReferendumInfoTo239, Vote } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
import type { PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts';
