...
import type { AccountId, ReferendumInfoTo239, Vote } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyVoteVoting } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
