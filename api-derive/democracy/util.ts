...
import type { ReferendumInfoTo239, Tally } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts';
...
import { BN, bnSqrt } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
