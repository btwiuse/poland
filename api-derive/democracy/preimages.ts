...
import type { AccountId, Balance, BlockNumber, Hash, PreimageStatus, Proposal } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { Bytes, Option } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
