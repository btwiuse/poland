...
import type { AccountId, Balance, BalanceLockTo212, BlockNumber, VestingSchedule } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
import type { PalletBalancesBalanceLock, PalletBalancesReserveData, PalletVestingVestingInfo } from 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts';
...
import { BN, BN_ZERO, bnMax, bnMin, isFunction } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
