...
import type { AccountId, Balance, BalanceLockTo212, BlockNumber, VestingSchedule } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletBalancesBalanceLock, PalletBalancesReserveData, PalletVestingVestingInfo } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
...
import { BN, BN_ZERO, bnMax, bnMin, isFunction } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
