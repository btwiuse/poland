...
import type { QueryableStorageEntry } from 'https://deno.land/x/polkadot@0.0.0-10/api-base/types/index.ts';
import type { AccountData, AccountId, AccountIndex, AccountInfo, Address, Balance, Index } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
