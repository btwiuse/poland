...
import type { AccountId, Balance, BalanceLockTo212, Index } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
import type { PalletBalancesBalanceLock, PalletBalancesReserveData } from 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts';
