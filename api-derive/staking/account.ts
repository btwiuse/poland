...
import type { Balance } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletStakingStakingLedger, PalletStakingUnlockChunk } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
...
import { BN, BN_ZERO } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
