...
import type { AccountId, Balance, EraIndex, RewardPoint } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletStakingExposure, PalletStakingRewardDestination, PalletStakingStakingLedger, PalletStakingValidatorPrefs } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
