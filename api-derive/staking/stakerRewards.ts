...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
