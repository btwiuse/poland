...
import type { Option } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { AccountId, EraIndex } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletStakingExposure, PalletStakingNominations, PalletStakingRewardDestination, PalletStakingStakingLedger, PalletStakingValidatorPrefs } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
