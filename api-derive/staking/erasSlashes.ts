...
import type { Option, StorageKey } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { BalanceOf, EraIndex, Perbill } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
