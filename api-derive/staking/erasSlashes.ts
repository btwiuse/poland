...
import type { Option, StorageKey } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { BalanceOf, EraIndex, Perbill } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
