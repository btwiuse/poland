...
import type { Compact } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
...
export type { BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
