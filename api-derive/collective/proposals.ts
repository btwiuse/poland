...
import type { Option, u32 } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { Hash, Proposal, Votes } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
...
export type { Option, u32 } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
export type { Hash, Proposal, Votes } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
