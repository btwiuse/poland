...
import type { Bytes, Option } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { BountyIndex } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
import type { PalletBountiesBounty } from 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts';
