...
import type { Bytes, Option } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { BountyIndex } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { PalletBountiesBounty } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';
