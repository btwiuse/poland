 ...
 *
 * ```javascript
 * import { stringLowerFirst } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
 *
 ...
 *
 * ```javascript
 * import { stringUpperFirst } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
 *
