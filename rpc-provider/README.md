...
```javascript
import { HttpProvider } from 'https://deno.land/x/polkadot@0.0.0-11/rpc-provider/mod.ts';
...
```javascript
import { ScProvider, WellKnownChain } from 'https://deno.land/x/polkadot@0.0.0-11/rpc-provider/substrate-connect/index.ts';
