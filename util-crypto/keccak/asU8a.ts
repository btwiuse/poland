...
import { keccak256, keccak512 } from 'https://deno.land/x/polkadot@0.0.0-11/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { keccakAsU8a } from 'https://deno.land/x/polkadot@0.0.0-11/util-crypto/mod.ts';
 *
