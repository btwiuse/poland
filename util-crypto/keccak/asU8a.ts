...
import { keccak256, keccak512 } from 'https://deno.land/x/polkadot@0.0.0-10/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { keccakAsU8a } from 'https://deno.land/x/polkadot@0.0.0-10/util-crypto/mod.ts';
 *
