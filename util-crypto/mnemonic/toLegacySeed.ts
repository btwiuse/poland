...
import { hasBigInt } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
import { bip39ToSeed, isReady } from 'https://deno.land/x/polkadot@0.0.0-11/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { mnemonicGenerate, mnemonicToLegacySeed, mnemonicValidate } from 'https://deno.land/x/polkadot@0.0.0-11/util-crypto/mod.ts';
 *
