...
import { stringToU8a } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
import { bip39ToMiniSecret, isReady } from 'https://deno.land/x/polkadot@0.0.0-10/wasm-crypto/mod.ts';
