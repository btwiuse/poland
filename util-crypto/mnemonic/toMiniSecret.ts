...
import { stringToU8a } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
import { bip39ToMiniSecret, isReady } from 'https://deno.land/x/polkadot@0.0.0-11/wasm-crypto/mod.ts';
