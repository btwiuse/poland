...
import { assert, u8aToU8a } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
import { ed25519Verify as wasmVerify, isReady } from 'https://deno.land/x/polkadot@0.0.0-11/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { ed25519Verify } from 'https://deno.land/x/polkadot@0.0.0-11/util-crypto/mod.ts';
 *
