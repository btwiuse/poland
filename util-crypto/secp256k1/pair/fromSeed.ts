...
import { hasBigInt, u8aEmpty } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
import { isReady, secp256k1FromSeed } from 'https://deno.land/x/polkadot@0.0.0-10/wasm-crypto/mod.ts';
