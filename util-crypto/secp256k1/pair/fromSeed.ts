...
import { hasBigInt, u8aEmpty } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
import { isReady, secp256k1FromSeed } from 'https://deno.land/x/polkadot@0.0.0-11/wasm-crypto/mod.ts';
