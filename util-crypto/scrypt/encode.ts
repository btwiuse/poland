...
import { hasBigInt, objectSpread, u8aToU8a } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
import { isReady, scrypt } from 'https://deno.land/x/polkadot@0.0.0-10/wasm-crypto/mod.ts';
