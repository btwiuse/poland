...
import type { IsEvent } from 'https://deno.land/x/polkadot@0.0.0-10/types/metadata/decorate/types.ts';
import type { AnyTuple } from 'https://deno.land/x/polkadot@0.0.0-10/types/types/index.ts';
