...
import type { IsEvent } from 'https://deno.land/x/polkadot@0.0.0-11/types/metadata/decorate/types.ts';
import type { AnyTuple } from 'https://deno.land/x/polkadot@0.0.0-11/types/types/index.ts';
