...
import type { StorageKey, u64 } from 'https://deno.land/x/polkadot@0.0.2/types/mod.ts';
...
import type { AnyFunction, AnyTuple, Callback, Codec, IStorageKey } from 'https://deno.land/x/polkadot@0.0.2/types/types/index.ts';
