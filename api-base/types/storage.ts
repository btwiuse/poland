...
import type { StorageKey, u64 } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
...
import type { AnyFunction, AnyTuple, Callback, Codec, IStorageKey } from 'https://deno.land/x/polkadot@0.0.0-11/types/types/index.ts';
