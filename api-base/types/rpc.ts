...
import type { AnyFunction, Callback, DefinitionRpc } from 'https://deno.land/x/polkadot@0.0.0-10/types/types/index.ts';

import { ApiTypes, PromiseResult, Push, RxResult, UnsubscribePromise } from './base.ts';

export type { AugmentedRpc } from 'https://deno.land/x/polkadot@0.0.0-10/rpc-core/types/index.ts';
