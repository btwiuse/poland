...
import { transports } from 'https://deno.land/x/polkadot@0.0.0-10/hw-ledger-transports/mod.ts';
import { u8aToBuffer } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
