...
import type { InitFn } from 'https://deno.land/x/polkadot@0.0.0-10/wasm-bridge/types.ts';
import type { WasmCryptoInstance } from 'https://deno.land/x/polkadot@0.0.0-10/wasm-crypto-init/types.ts';

import { Bridge } from 'https://deno.land/x/polkadot@0.0.0-10/wasm-bridge/mod.ts';
import { createWasm } from 'https://deno.land/x/polkadot@0.0.0-10/wasm-crypto-init/mod.ts';
