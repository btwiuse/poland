...
declare module 'https://deno.land/x/polkadot@0.0.0-10/types/lookup.ts' {
  import type { Compact, Enum, Null, Struct, Vec, u16, u32 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
  import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
  import type { PerU16 } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
