...
declare module 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts' {
  import type { BitVec, Bytes, Compact, Enum, Null, Option, Result, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
  ...
  import type { AccountId32, H256, PerU16 } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
