...
import { from, Observable } from 'https://esm.sh/rxjs@7.5.5';

import { objectSpread } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
 ...
 *
 * ```javascript
 * import ApiRx from 'https://deno.land/x/polkadot@0.0.0-11/api/rx/index.ts';
 *
 ...
 *
 * ```javascript
 * import { combineLatest, pairwise, switchMap } from 'https://esm.sh/rxjs@7.5.5';
 * import { ApiRx, WsProvider } from 'https://deno.land/x/polkadot@0.0.0-11/api/mod.ts';
 *
 *
 ...
 *
 * ```javascript
 * import { first, switchMap } from 'https://esm.sh/rxjs@7.5.5';
 * import ApiRx from 'https://deno.land/x/polkadot@0.0.0-11/api/rx/index.ts';
 *
 * // import the test keyring (already has dev keys for Alice, Bob, Charlie, Eve & Ferdie)
 * import testingPairs from 'https://deno.land/x/polkadot@0.0.0-11/keyring/testingPairs.ts';
...
export class ApiRx extends ApiBase<'rxjs'> {
   ...
   * import Api from 'https://deno.land/x/polkadot@0.0.0-11/api/rx/index.ts';
   *
   * new Api().isReady
   *   .pipe(
   *     switchMap((api) =>
