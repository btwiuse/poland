...
import { objectSpread } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
 ...
 *
 * ```javascript
 * import ApiRx from 'https://deno.land/x/polkadot@0.0.0-10/api/rx/index.ts';
 *
 ...
 * import { ApiRx, WsProvider } from 'https://deno.land/x/polkadot@0.0.0-10/api/mod.ts';
 *
 *
 ...
 * import testingPairs from 'https://deno.land/x/polkadot@0.0.0-10/keyring/testingPairs.ts';
...
export class ApiRx extends ApiBase<'rxjs'> {
   ...
   * import Api from 'https://deno.land/x/polkadot@0.0.0-10/api/rx/index.ts';
   *
   * new Api().isReady
   *   .pipe(
   *     switchMap((api) =>
