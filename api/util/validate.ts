...
import type { SiLookupTypeId } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
...
import { assert, isUndefined } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
