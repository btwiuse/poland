...
import type { ExactDerive } from 'https://deno.land/x/polkadot@0.0.0-10/api-derive/mod.ts';
import type { AnyFunction } from 'https://deno.land/x/polkadot@0.0.0-10/types/types/index.ts';
import type { ApiTypes, DecorateMethod, MethodResult } from '../types/index.ts';

import { lazyDeriveSection } from 'https://deno.land/x/polkadot@0.0.0-10/api-derive/mod.ts';
