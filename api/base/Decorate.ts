...
import type { DeriveCustom } from 'https://deno.land/x/polkadot@0.0.2/api-base/types/index.ts';
import type { RpcInterface } from 'https://deno.land/x/polkadot@0.0.2/rpc-core/types/index.ts';
import type { Option, Raw, StorageKey, Text, u64 } from 'https://deno.land/x/polkadot@0.0.2/types/mod.ts';
import type { Call, Hash, RuntimeVersion } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/index.ts';
import type { DecoratedMeta } from 'https://deno.land/x/polkadot@0.0.2/types/metadata/decorate/types.ts';
import type { StorageEntry } from 'https://deno.land/x/polkadot@0.0.2/types/primitive/types.ts';
import type { AnyFunction, AnyTuple, CallFunction, Codec, DefinitionRpc, DefinitionRpcSub, DetectCodec, IMethod, IStorageKey, Registry, RegistryError, RegistryTypes } from 'https://deno.land/x/polkadot@0.0.2/types/types/index.ts';
...
import { getAvailableDerives } from 'https://deno.land/x/polkadot@0.0.2/api-derive/mod.ts';
import { memo, RpcCore } from 'https://deno.land/x/polkadot@0.0.2/rpc-core/mod.ts';
import { WsProvider } from 'https://deno.land/x/polkadot@0.0.2/rpc-provider/mod.ts';
import { expandMetadata, Metadata, TypeRegistry, unwrapStorageType } from 'https://deno.land/x/polkadot@0.0.2/types/mod.ts';
import { arrayChunk, arrayFlatten, assert, assertReturn, BN, compactStripLength, lazyMethod, lazyMethods, logger, nextTick, objectSpread, u8aToHex } from 'https://deno.land/x/polkadot@0.0.2/util/mod.ts';

import { createSubmittable } from '../submittable/index.ts';
import { augmentObject } from '../util/augmentObject.ts';
import { AllDerives, decorateDeriveSections } from '../util/decorate.ts';
...
export abstract class Decorate<ApiType extends ApiTypes> extends Events {
   ...
   *
   * ```javascript
   * import Api from 'https://deno.land/x/polkadot@0.0.2/api/promise/index.ts';
   *
