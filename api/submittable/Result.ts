...
import type { DispatchError, DispatchInfo, EventRecord, ExtrinsicStatus, Hash } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
import type { AnyJson, ISubmittableResult } from 'https://deno.land/x/polkadot@0.0.0-11/types/types/index.ts';
