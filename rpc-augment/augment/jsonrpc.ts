...
import type { AugmentedRpc } from 'https://deno.land/x/polkadot@0.0.3/rpc-core/types/index.ts';
import type { Metadata, StorageKey } from 'https://deno.land/x/polkadot@0.0.3/types/mod.ts';
import type { Bytes, HashMap, Json, Null, Option, Text, U256, U64, Vec, bool, f64, u32, u64 } from 'https://deno.land/x/polkadot@0.0.3/types-codec/mod.ts';
import type { AnyNumber, Codec } from 'https://deno.land/x/polkadot@0.0.3/types-codec/types/index.ts';
import type { ExtrinsicOrHash, ExtrinsicStatus } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/author/index.ts';
import type { EpochAuthorship } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/babe/index.ts';
import type { BeefySignedCommitment } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/beefy/index.ts';
import type { BlockHash } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/chain/index.ts';
import type { PrefixedStorageKey } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/childstate/index.ts';
import type { AuthorityId } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/consensus/index.ts';
import type { CodeUploadRequest, CodeUploadResult, ContractCallRequest, ContractExecResult, ContractInstantiateResult, InstantiateRequest } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/contracts/index.ts';
import type { BlockStats } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/dev/index.ts';
import type { CreatedBlock } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/engine/index.ts';
import type { EthAccount, EthCallRequest, EthFeeHistory, EthFilter, EthFilterChanges, EthLog, EthReceipt, EthRichBlock, EthSubKind, EthSubParams, EthSyncStatus, EthTransaction, EthTransactionRequest, EthWork } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/eth/index.ts';
import type { Extrinsic } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/extrinsics/index.ts';
import type { EncodedFinalityProofs, JustificationNotification, ReportedRoundStates } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/grandpa/index.ts';
import type { MmrLeafBatchProof, MmrLeafProof } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/mmr/index.ts';
import type { StorageKind } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/offchain/index.ts';
import type { FeeDetails, RuntimeDispatchInfo } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/payment/index.ts';
import type { RpcMethods } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/rpc/index.ts';
import type { AccountId, BlockNumber, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, SignedBlock, StorageData } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/runtime/index.ts';
import type { MigrationStatusResult, ReadProof, RuntimeVersion, TraceBlockResponse } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/state/index.ts';
import type { ApplyExtrinsicResult, ChainProperties, ChainType, Health, NetworkState, NodeRole, PeerInfo, SyncState } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/system/index.ts';
import type { IExtrinsic, Observable } from 'https://deno.land/x/polkadot@0.0.3/types/types/index.ts';

declare module 'https://deno.land/x/polkadot@0.0.3/rpc-core/types/jsonrpc.ts' {
