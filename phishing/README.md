...
```js
import { checkIfDenied } from 'https://deno.land/x/polkadot@0.0.0-11/phishing/mod.ts';
...
```js
import { checkAddress } from 'https://deno.land/x/polkadot@0.0.0-11/phishing/mod.ts';
