...
import type { AnyJson, AnyTuple, Codec } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import { isFunction, isString, isU8a } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
