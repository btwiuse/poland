...
import type { AnyJson, AnyTuple, Codec } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import { isFunction, isString, isU8a } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
