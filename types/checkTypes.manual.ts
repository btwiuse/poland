...
import 'https://deno.land/x/polkadot@0.0.0-10/types-augment/mod.ts';

import type { Bytes, Compact, Option, u32 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { IOption, ITuple } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
