...
import type { AnyJson, AnyNumber, AnyTuple, AnyU8a, Codec } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
...
import type { DispatchError, DispatchInfo, EventRecord } from '../interfaces/system/index.ts';
import type { ICompact, IKeyringPair, IMethod, INumber, IRuntimeVersionBase } from './interfaces.ts';
