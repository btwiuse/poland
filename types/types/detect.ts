...
import type { InterfaceTypes } from 'https://deno.land/x/polkadot@0.0.0-10/types/types/index.ts';
import type { bool, BTreeMap, BTreeSet, Bytes, CodecSet, Compact, Enum, HashMap, Linkage, Null, Option, OptionBool, Range, RangeInclusive, Result, Struct, u8, U8aFixed, Vec, VecFixed } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { Codec, ICompact, IEnum, IMap, IMethod, INumber, IOption, IResult, ISet, IStruct, ITuple, IU8a, IVec } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
