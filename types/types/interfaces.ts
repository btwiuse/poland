...
import type { AnyTuple, Codec, IMethod as IMethodBase, INumber, IText } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
import type { FunctionMetadataLatest, StorageEntryMetadataLatest } from '../interfaces/metadata/index.ts';
import type { Registry } from './registry.ts';

export type { ICompact, IEnum, IMap, INumber, IOption, IResult, ISet, IStruct, IText, ITuple, IU8a, IVec } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
