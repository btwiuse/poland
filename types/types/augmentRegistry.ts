...
import 'https://deno.land/x/polkadot@0.0.0-11/types-create/types/augmentRegistry.ts';

import type { Codec, CodecClass } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
...
declare module 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/registry.ts' {
