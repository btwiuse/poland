...
import type { Struct, u32 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { AccountId, Balance, BlockNumber, Perquintill } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
