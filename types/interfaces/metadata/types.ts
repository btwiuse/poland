...
import type { PortableRegistry } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { Bytes, Enum, Option, Struct, Text, Type, Vec, bool, u8 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { Si1Field, Si1LookupTypeId, Si1Type, SiLookupTypeId } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/scaleInfo/index.ts';
