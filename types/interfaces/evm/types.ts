...
import type { Bytes, Enum, Struct, Text, Vec, u256 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { H160, H256 } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
