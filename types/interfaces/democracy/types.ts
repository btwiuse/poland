...
import type { Bytes, Enum, Option, Struct, Vec, bool, u32 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
import type { Vote, VoteThreshold } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/elections/index.ts';
import type { AccountId, Balance, BlockNumber, Call, Hash } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
