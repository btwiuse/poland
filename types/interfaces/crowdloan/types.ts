...
import type { Enum, Option, Struct, u32 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { LeasePeriod } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/parachains/index.ts';
import type { AccountId, Balance, BlockNumber, MultiSigner } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
