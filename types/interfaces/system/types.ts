...
import type { GenericChainProperties, GenericEvent } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { Bytes, Compact, Enum, HashMap, Option, Result, Struct, Text, U8aFixed, Vec, bool, i32, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
import type { AccountData } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/balances/index.ts';
import type { AccountId, BlockNumber, Digest, Hash, Index, Pays, Weight } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
