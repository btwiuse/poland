...
import type { Struct, Vec, u16 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { AccountId, Balance, BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
