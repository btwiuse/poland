...
import type { Bytes, Compact, Struct, bool, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { AccountId, BalanceOf } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
