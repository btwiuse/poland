...
import type { BTreeMap, BitVec, Bytes, Enum, Option, Struct, U8aFixed, Vec, bool, u32 } from 'https://deno.land/x/polkadot@0.0.3/types-codec/mod.ts';
...
import type { AccountId, Balance, BalanceOf, BlockNumber, H256, Hash, Header, StorageProof, ValidatorId, Weight } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/runtime/index.ts';
import type { MembershipProof, SessionIndex } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/session/index.ts';
