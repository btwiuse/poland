...
import type { GenericVote } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import type { Compact, Enum, Struct, u32 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
