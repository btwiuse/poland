...
import type { BitVec, Bytes, Enum, Null, Struct, U8aFixed, Vec, bool, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
...
import type { MultiSignature } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/extrinsics/index.ts';
import type { AuthorityList, SetId } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/grandpa/index.ts';
import type { AccountId, Balance, BlockNumber, H256, Header, MultiSigner, Weight } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
