...
import type { GenericEthereumAccountId, GenericEthereumLookupSource } from 'https://deno.land/x/polkadot@0.0.0-11/types/mod.ts';
import type { Bytes, Enum, Option, Struct, U256, U64, U8aFixed, Vec, bool, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { BlockNumber, H160, H2048, H256, H64 } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
