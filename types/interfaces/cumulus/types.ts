...
import type { Struct, U8aFixed, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { Weight } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
