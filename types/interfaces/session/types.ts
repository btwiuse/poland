...
import type { Bytes, Struct, U8aFixed, Vec, u32 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
import type { AccountId, ValidatorId } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
import type { Exposure } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/staking/index.ts';
