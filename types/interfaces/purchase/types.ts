...
import type { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { Balance, Permill } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
