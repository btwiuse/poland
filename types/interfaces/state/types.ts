...
import type { Bytes, Enum, HashMap, Option, Struct, Text, U8aFixed, Vec, bool, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
import type { Hash, StorageData } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
