...
import type { GenericAccountId, GenericAccountIndex, GenericBlock, GenericCall, GenericConsensusEngineId, GenericEthereumAccountId, GenericLookupSource, GenericMultiAddress, StorageKey } from 'https://deno.land/x/polkadot@0.0.3/types/mod.ts';
import type { Bytes, Compact, DoNotConstruct, Enum, Int, Null, Option, Struct, U8aFixed, UInt, Vec, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.3/types-codec/mod.ts';
...
import type { Signature } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/extrinsics/index.ts';
import type { SystemOrigin } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/system/index.ts';
