...
import type { GenericAccountId, GenericAccountIndex, GenericBlock, GenericCall, GenericConsensusEngineId, GenericEthereumAccountId, GenericLookupSource, GenericMultiAddress, StorageKey } from 'https://deno.land/x/polkadot@0.0.2/types/mod.ts';
import type { Bytes, Compact, DoNotConstruct, Enum, Int, Null, Option, Struct, U8aFixed, UInt, Vec, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.2/types-codec/mod.ts';
...
import type { SystemOrigin } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/system/index.ts';
