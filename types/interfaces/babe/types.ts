...
import type { Enum, Option, Struct, U8aFixed, Vec, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
...
import type { Hash, Header } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
