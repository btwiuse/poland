...
import type { Bytes, Enum, Text, Vec } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { Hash } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
