...
import type { Bytes, Struct, Vec, u32 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { Signature } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/extrinsics/index.ts';
import type { BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
