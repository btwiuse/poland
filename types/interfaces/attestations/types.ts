...
import type { Struct, Vec } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { CandidateReceipt, ParaId } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/parachains/index.ts';
import type { AccountId, BlockNumber, H256, Hash } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
import type { SessionIndex } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/session/index.ts';
