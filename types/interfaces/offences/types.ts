...
import type { Bytes, Struct, U8aFixed, Vec } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
import type { AccountId, Hash, Perbill } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
import type { IdentificationTuple, SessionIndex } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/session/index.ts';
