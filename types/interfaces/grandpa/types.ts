...
import type { BTreeSet, Bytes, Enum, Option, Struct, U64, Vec, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
...
import type { AuthoritySignature } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/imOnline/index.ts';
import type { BlockNumber, Hash, Header } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
import type { MembershipProof } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/session/index.ts';
