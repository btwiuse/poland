...
import type { Bytes, Compact, Enum, Null, Option, Raw, Result, Set, Struct, Text, U8aFixed, bool, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { AccountId, Balance, BlockNumber, Hash, Weight } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
import type { DispatchError } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/system/index.ts';
