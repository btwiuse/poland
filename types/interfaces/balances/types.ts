...
import type { Enum, Set, Struct, U8aFixed } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { Balance, BlockNumber, LockIdentifier } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
