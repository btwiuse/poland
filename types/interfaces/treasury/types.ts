...
import type { Enum, Option, Struct, Vec, bool, u32 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
import type { AccountId, Balance, BlockNumber, Hash } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
