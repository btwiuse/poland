...
import type { Option, Struct } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { Balance, Weight } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
import type { DispatchClass } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/system/index.ts';
