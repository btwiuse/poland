...
import type { Struct, Vec, u32 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { AccountId, Balance, BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
