...
import type { Codec, CodecClass, Registry } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
import type { DetectCodec } from '../types/index.ts';

import { createClassUnsafe } from 'https://deno.land/x/polkadot@0.0.0-10/types-create/mod.ts';
