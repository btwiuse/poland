...
import { Option, Struct, Text, Vec } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import { objectProperty, objectSpread, u8aToHex } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
