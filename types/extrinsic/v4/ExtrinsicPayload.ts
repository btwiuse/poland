...
import type { SignOptions } from 'https://deno.land/x/polkadot@0.0.0-10/keyring/types.ts';
...
import { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
