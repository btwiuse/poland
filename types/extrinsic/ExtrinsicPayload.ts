...
import type { AnyJson, BareOpts, Registry } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
...
import { AbstractBase, Raw } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
