...
import type { AnyTuple, Registry } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
...
import { isCodec, isU8a, lazyMethod, stringCamelCase } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
