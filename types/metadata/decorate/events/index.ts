...
import type { AnyTuple, Registry } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
...
import { isCodec, isU8a, lazyMethod, stringCamelCase } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
