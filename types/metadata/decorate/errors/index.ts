...
import type { Text, u8 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
...
import { isCodec, isU8a, lazyMethod, objectSpread, stringCamelCase } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
