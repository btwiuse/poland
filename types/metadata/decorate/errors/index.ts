...
import type { Text, u8 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
...
import { isCodec, isU8a, lazyMethod, objectSpread, stringCamelCase } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
