...
import type { AnyJson, AnyTuple, Registry } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
import type { Call, FunctionMetadataLatest } from '../../../interfaces/index.ts';
import type { CallFunction, IMethod } from '../../../types/index.ts';

import { stringCamelCase } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
