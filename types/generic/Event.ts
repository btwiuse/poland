...
import type { AnyJson, Codec, CodecClass } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
import type { TypeDef } from 'https://deno.land/x/polkadot@0.0.0-10/types-create/types/index.ts';
...
import { Null, Struct, Tuple } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import { objectProperties, objectSpread } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
