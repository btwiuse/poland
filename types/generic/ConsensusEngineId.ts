...
import { Bytes, U8aFixed, u32 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import { BN, bnToU8a, isNumber, stringToU8a, u8aToHex, u8aToString } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
