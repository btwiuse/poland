...
import type { Vec } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { AnyNumber, AnyU8a, IU8a, Registry } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
