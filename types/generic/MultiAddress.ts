...
import { Enum } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import { isBn, isNumber, isString, isU8a } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
