...
import { Enum } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import { isBn, isNumber, isString, isU8a } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
