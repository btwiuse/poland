...
import type { Option, Text } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { ICompact, INumber } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
