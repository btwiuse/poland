...
import type { Option, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/mod.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.0.0-11/types-codec/types/index.ts';
import type { Perbill, Percent, Permill } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/runtime/index.ts';
import type { FrameSupportPalletId, FrameSupportWeightsRuntimeDbWeight, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, PalletContractsSchedule, SpVersionRuntimeVersion } from 'https://deno.land/x/polkadot@0.0.0-11/types/lookup.ts';

declare module 'https://deno.land/x/polkadot@0.0.0-11/api-base/types/consts.ts' {
