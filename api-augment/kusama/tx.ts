...
import type { Bytes, Compact, Option, U8aFixed, Vec, WrapperKeepOpaque, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/mod.ts';
import type { AnyNumber, IMethod, ITuple } from 'https://deno.land/x/polkadot@0.0.0-10/types-codec/types/index.ts';
import type { EthereumAddress } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/eth/index.ts';
import type { AccountId32, Call, H256, MultiAddress, Perbill, Percent, Perquintill } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/runtime/index.ts';
...
declare module 'https://deno.land/x/polkadot@0.0.0-10/api-base/types/submittable.ts' {
