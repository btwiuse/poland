...
import type { AccountId, EventRecord, Hash } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
...
import { BN_ZERO, isUndefined } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
