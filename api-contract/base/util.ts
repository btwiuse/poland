...
import type { SubmittableResult } from 'https://deno.land/x/polkadot@0.0.0-10/api/mod.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
import { compactAddLength, u8aToU8a } from 'https://deno.land/x/polkadot@0.0.0-10/util/mod.ts';
