...
import type { EventRecord } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';
...
import { isBigInt, isBn, isNumber, isString } from 'https://deno.land/x/polkadot@0.0.0-11/util/mod.ts';
