...
import type { ContractMetadataV0, ContractMetadataV1 } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';
import type { Registry } from 'https://deno.land/x/polkadot@0.0.0-10/types/types/index.ts';

import { convertSiV0toV1 } from 'https://deno.land/x/polkadot@0.0.0-10/types/mod.ts';
