...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.0.0-11/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.0.0-11/api/mod.ts';
