...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.0.0-10/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.0.0-10/api/mod.ts';
